...
CLG 当前是一套工作模型，用来研究企业如何选择能力、把它送到用户身边、完成第一次价值
交付，并延续后续关系。它还不完整，也不必假装已经有了 AI 时代营销的答案。当前项目要做
的，是用企业分析 Skill 持续打磨这条路径，再把实践中反复出现的机制抽象出来。

如果一些判断被推翻，就修改模型；如果连续实践表明它没有独特解释力，就把有效部分并回
PLG、免费工具或内容营销。研究的目标不是保住 CLG 这个名字，而是更接近一种真正适合 AI
能力分发时代的营销方法。
