...
> 当一项产品能力能够被单独分发，并在用户已有环境中交付结果时，能力使用本身可能成为
> 一条增长路径。
...
CLG 并不是 PLG 的替代品。多数情况下，它更像 PLG 或销售流程之前的一段路：先用一个
具体结果建立价值认知，再由完整产品、服务或销售承接后续关系。
...
工作，而不是观看营销材料。任务结果可能比营销主张更有说服力，但它是否真的提高转化，
仍要靠实验回答。
...
但“离开产品”本身也不构成新类别。只有当这种分发方式带来原本不会发生的有效使用和后续
关系，CLG 才有必要被单独讨论。
...
在建设通用平台之前，应该先验证一条具体增长链路。

最简单的实验，是为同一项能力准备两个版本：
...
如果没有增量，增加更多 Hook 和适配器不会解决问题。更完整的实验设计见
[《怎么判断 CLG 到底有没有用》](./research/falsification-agenda.md)。
...
如果实验成立，再抽象 Skill Pack、能力治理和跨载体运营工具。否则，当前发现更适合被
理解为一种更好的产品演示方式，而不是新的增长模式。

## 我现在押注什么

AI 正在让一部分产品能力从完整应用和专家服务中被拆出来，成为可以单独设计和分发的对象。
我押注这些能力会成为新的产品资产：它们会被单独设计、评测、治理和分发。

我暂时不押注 CLG 会成为一个与 PLG 并列的增长大类。当前要做的，是用企业分析 Skill
回答一个更小的问题：当能力先进入用户环境、先完成任务时，它是否带来了更多复用、留资、
销售机会和付费？

这轮实验的答案，会决定项目下一步是继续建设能力运营工具，还是退回到一个更好的产品
演示工具。
